...
arranged in a regular fashion on the floor-plan. The load wire
...
// To mark invalid or non existent values
#define NOT_VALID             						-1
...
#define SER_ENRG_PERBIT_PJ						    0.25 //Serializer/Deserializer energy in pJ/bit
#define TIA_ENRG_PERGBPS							0.075

#if MODULTN_SCHEME==ODAC
#define DRIVER_ENRG_PERGBPS                    		0.042//in mW/Gbps or pJ/bit
#elif MODULTN_SCHEME==EDAC
#define DRIVER_ENRG_PERGBPS                    		3.04//in mW/Gbps or pJ/bit
#else
#define DRIVER_ENRG_PERGBPS                    		0.154//in mW/Gbps or pJ/bit
#endif

#if MODULTN_SCHEME==SS
#define MODULATOR_ENRG_USAGE						2*(SER_ENRG_PERBIT_PJ+ DRIVER_ENRG_PERGBPS)/pow(10,12)
#else
...
#else
#define NOC_PHOTONIC_CLK							0.2//0.2 Corresponds to 10Gbps
#endif
...
#if MODULTN_SCHEME!=OOK
#define PHOTO_DEL_CYCLES							(PACKET_SIZE/(2*N_LAMBDA))
#else
#define PHOTO_DEL_CYCLES							(PACKET_SIZE/(N_LAMBDA))
#endif
...
#define DEFAULT_BUFFER_DEPTH                        10
...
#define DEFAULT_SIMULATION_TIME                  	10000000
...
#define DEFAULT_WAVEGUIDE_CFACTOR                   (DEFAULT_MESH_DIM_X * DEFAULT_MESH_DIM_Y) / (DEFAULT_MWMR_WAVEGUIDES)
...
struct TGlobalParams {
    ...
    static float waveguide_cfactor;
